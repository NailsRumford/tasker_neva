...
urlpatterns = [
    ...
    path('fire_alarm_object/create/', views.create_fire_alarm_object,
         name='create_fire_alarm_object'),
    path('fire_alarm_object/<int:object_id>/edite/',
         views.fire_alarm_object_edite, name='fire_alarm_object_edite'),
